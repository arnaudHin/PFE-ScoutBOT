...
void I2C_Init(I2C_TypeDef* I2Cx, uint32_t clockSpeed){
	...
	if(id == I2C5_ID)
	{
		...
		BSP_GPIO_PinCfg(I2C5_SDA_GPIO, I2C5_SDA_PIN, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH, GPIO_AF4_I2C5);
		BSP_GPIO_PinCfg(I2C5_SCL_GPIO, I2C5_SCL_PIN, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH, GPIO_AF4_I2C5);
	}
