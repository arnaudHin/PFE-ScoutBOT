...
static gboolean on_draw1_draw(GtkWidget *p_wid, cairo_t *cr, gpointer data)
{
  // guint width, height;
   ...
   // {
   //    z++;
   //    cairo_rectangle(cr, 0.98 * i + 4, 1.8 * z + 8, 5.5, 5.5);
   // }
...
static void css_set(GtkCssProvider *, GtkWidget *);
...
static void css_set(GtkCssProvider *cssProvider, GtkWidget *g_widget)
{
