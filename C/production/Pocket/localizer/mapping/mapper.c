...
static Transition_t myTransition[NB_STATE_M][E_NB_EVENT_M] = {
	...
	[S_SCANNING_M][E_NOP_M] = {S_SCANNING_M, T_SCANNING_M},

	[S_SCANNING_M][E_ASK_4_LIDAR_DATA_M] = {S_SCANNING_M, T_ASK_4_LIDAR_DATA_M},
...
extern void cartographer_signal_start_scanning(){
    mapper_mq_send(E_START_MAPPER_M);
}

extern void mapper_ask4data(){
    mapper_mq_send(E_ASK_4_LIDAR_DATA_M);
}
